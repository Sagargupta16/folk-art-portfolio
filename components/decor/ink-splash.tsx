		...
		>
			...
			>
				...
				<g filter="url(#ink-splash-feather)">
					{/* Primary tone -- the largest wash */}
					<ellipse cx="220" cy="170" rx="170" ry="120" fill={tone} opacity={baseAlpha} />
					<ellipse cx="320" cy="240" rx="120" ry="90" fill={tone} opacity={baseAlpha * 0.7} />
					<ellipse cx="140" cy="240" rx="90" ry="70" fill={tone} opacity={baseAlpha * 0.5} />
