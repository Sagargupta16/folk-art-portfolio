...
export default function Section({ id, eyebrow, title, lead, accent, align = 'left', children }: Props) {
      ...
      <div className="container-x">
        {(eyebrow || title || lead) && (
          <header className={`stagger mb-10 sm:mb-14 ${textAlign}`}>
            ...
            {title && <h2 className="t-display reveal text-4xl text-[var(--color-ink)] sm:text-5xl">{title}</h2>}
