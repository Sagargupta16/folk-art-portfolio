...
import { Instagram, Whatsapp, Mail } from '@/components/ui/icons';
...
export default function Contact() {
  return (
    <Section id="contact" eyebrow={c.eyebrow} title={c.title} lead={c.lead} accent="var(--color-peacock)">
            ...
            <li key={it.label} className="reveal">
              ...
              >
                <span className="t-meta inline-flex items-center gap-2">
                  {Icon && <Icon className="text-[var(--color-muted)] transition group-hover:text-[var(--section-accent)]" />}
                  {it.label}
                </span>
